...
pub fn mock_register_voting_token(deps: DepsMut) {
    ...
    let msg = ExecuteMsg::RegisterContracts {
        pollterra_token: VOTING_TOKEN.to_string(),
    };
...
fn fails_create_poll_invalid_long_link() {
    ...
    let long_link = String::from("https://loooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong.com");
    let msg = create_poll_msg(
        "valid title".to_string(),
        "valid description".to_string(),
        Some(long_link),
